...
child.stdout.on('data', (data) => {
  ...
  if (
    line.includes(
      '[minecraft/DedicatedServer]: Done! Export in kubejs/exported/kubejs-server-export.json'
    )
  ) {
    console.log('exit(0)');
  ...
  if (
    line.includes('[minecraft/MinecraftServer]: Exception stopping the server')
  ) {
    console.log('exit(1)');
