...
$CURSEFORGE_USER = "inconvenientdev"
...
$MODPACK_NAME = "inconvenient"

# Name of the Modpack in the ZIP File
$CLIENT_NAME = "an-inconvenient-modpack"

# Version Of The Modpack
$MODPACK_VERSION = "0.6.8"

# Last Version Of The Modpack
# Needed For Changelog Parsing
$LAST_MODPACK_VERSION = "0.6.7"
