onEvent('recipes', event => {
  ...
  event
    ...
    .id('inconvenient:elite_table_amadron_tablet');
  ...
  event
    ...
    .id('inconvenient:elite_table_aerometer');
  ...
  event
    ...
    .id('inconvenient:crusher_ilmenite');
  event
    .custom({
      type: 'immersiveengineering:crusher',
      secondaries: [],
    ...
    .id('inconvenient:crusher_pentlandite');
  event
    .custom({
      type: 'immersiveengineering:crusher',
      secondaries: [],
    ...
    .id('inconvenient:crusher_uraninite');
  ...
  event
    ...
    .id('inconvenient:blueprint_component_electronic_adv');
  ...
  event
    ...
    .id('inconvenient:arc_ender_ingot');
  event
    .custom({
      type: 'immersiveengineering:arc_furnace',
  ...
  event
    ...
    .id('inconvenient:arc_nickel_ingot');
  event
    .custom({
      type: 'immersiveengineering:arc_furnace',
    ...
    .id('inconvenient:arc_uranium_ingot');
  ...
  event
    ...
    .id('inconvenient:mechanical_base');
  ...
  event
    ...
    .id('inconvenient:mechanical_personal_shrinking_device');
  ...
  event
    ...
    .id('inconvenient:crushing_pentlandite_ore');
  ...
  event
    ...
    .id('inconvenient:crushing_uraninite_ore');
  event
    .custom({
      input: {item: 'rankine:ilmenite_ore'},
      type: 'rankine:crushing',
    ...
    .id('inconvenient:crushing_ilmenite_ore');
  event
    .custom({
      input: {item: 'rankine:pentlandite_ore'},
      type: 'rankine:crushing',
  ...
  event
    ...
    .id('inconvenient:crushing_bituminous_ore');
  event
    .custom({
    ...
    .id('inconvenient:crushing_subbituminous_ore');
