  ...
  setBalanceRecipes({
    ...
    crushing: () => {
      ...
      event
        ...
        .id('inconvenient:crushing_wheel_raw_soulstone');
      event
        .custom({
        ...
        .id('inconvenient:crushing_wheel_cluster_of_brilliance');
      ...
      event
        ...
        .id('inconvenient:crushing_wheel_sodium_chloride');
    ...
    mixing: () => {
      ...
      event
        ...
        .id('inconvenient:mixing_pie_crust');
    ...
    pressing: () => {
      ...
      // }).id('inconvenient:pressing_zinc_plate');
      event
        .custom({
          type: 'create:pressing',
