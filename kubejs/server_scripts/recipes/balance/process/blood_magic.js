onEvent('recipes', event => {
  setBalanceRecipes({
    shapeless: () => {
      event
        .shapeless('bloodmagic:enhancedteleposerfocus', [
          'bloodmagic:teleposerfocus',
          'bloodmagic:strong_tau',
        ])
        .id('inconvenient:shapeless_enhancedteleposerfocus');
    },
    alchemy: () => {
      event.remove({
        output: [
      ...
      event
        ...
        .id('inconvenient:alchemy_bow_velocity_anointment');
      event
        .custom({
          type: 'bloodmagic:alchemytable',
          input: [
        ...
        .id('inconvenient:alchemy_smelting_anointment');
      event
        .custom({
          type: 'bloodmagic:alchemytable',
          input: [
        ...
        .id('inconvenient:alchemy_holy_water_anointment');
      event
        .custom({
          type: 'bloodmagic:alchemytable',
          input: [
        ...
        .id('inconvenient:alchemy_fortune_anointment');
      event
        .custom({
          type: 'bloodmagic:alchemytable',
          input: [
        ...
        .id('inconvenient:alchemy_saltpeter');
    },
    altar: () => {
      event.remove({
        output: [
    ...
    arc: () => {
      ...
      event
        ...
        .id('inconvenient:arc_fragment_netherite_scrap');
    },
    array: () => {},
    soul_forge: () => {
      event.remove({
