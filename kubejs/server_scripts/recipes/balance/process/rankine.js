onEvent('recipes', event => {
  setBalanceRecipes({
    shaped: () => {
      ...
      event
        .shaped('rankine:fiber_block', ['aaa', 'aaa', 'aaa'], {
          a: 'paragon_textiles:plant_fibers',
        })
        .id('inconvenient:shaped_fiber_block');
      event
    ...
    shapeless: () => {
      [
        'rankine:glass_from_colors',
        'rankine:yellow_fiber_mat_from_dye',
        'rankine:yellow_fiber_block_from_dye',
      ].forEach(id => event.remove({id: id}));
      event
        .shapeless('rankine:yellow_fiber_block', [
          'rankine:fiber_block',
          'minecraft:yellow_dye',
        ])
        .id('inconvenient:shapeless_yellow_fiber_block');
      event
        .shapeless('rankine:yellow_fiber_mat', [
          'rankine:fiber_mat',
          'minecraft:yellow_dye',
        ])
        .id('inconvenient:shapeless_yellow_fiber_mat');
    },
    air_distillation: () => {},
    alloying: () => {
      [
      ...
      event
        ...
        .id('inconvenient:alloying_neptunium_alloy_ingot');
      ...
      event
        ...
        .id('inconvenient:alloying_nickel_silver_ingot');
      ...
      event
        ...
        .id('inconvenient:alloying_titanium_alloy_ingot');
    },
    beehive_oven: () => {
      event.remove({
        output: [
      ...
      event
        ...
        .id('inconvenient:beehive_oven_scorched_stone');
    },
    crushing: () => {
      event.remove({
        input: [
      ...
      event
        ...
        .id('inconvenient:crushing_gravel');
      event
        .custom({
        ...
        .id('inconvenient:crushing_light_gravel');
    ...
    intrusive_igneous_generator: () => {
      ...
      event
        ...
        .id('inconvenient:intrusive_igneous_stone');
      event
        .custom({
          type: 'rankine:rock_generator',
          genType: 'intrusive_igneous',
        ...
        .id('inconvenient:intrusive_igneous_granite');
    },
    ...
    mixing: () => {
      ...
      event
        ...
        .id('inconvenient:mixing_barrel_pumice_soap');
      event
        .custom({
          type: 'rankine:mixing',
          mixTime: 100,
